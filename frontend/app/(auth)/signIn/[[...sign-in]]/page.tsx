...
export default function SignInPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a]">
      ...
      {/* Ambient glow orbs */}
      <div className="absolute top-1/4 left-1/3 w-96 h-96 rounded-full bg-phonix-copper/10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-phonix-gold/8 blur-[100px] pointer-events-none" />

      {/* Content */}
      <div
        ref={containerRef}
        className="content-layer flex flex-col items-center gap-8 px-4 transition-all duration-1000 ease-out"
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-gray-500">Sign in to continue your speech learning journey</p>
        </div>
        ...
        <p className="text-xs text-gray-600">
          ...
          <a href="/signUp" className="text-phonix-gold hover:text-white transition-colors font-medium">
            Create one
          </a>
        </p>
      </div>
